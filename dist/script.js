...
window.addEventListener("DOMContentLoaded", function () {
  var modalState = {};
  var modalsOff = false;
  var dataTime = "2022-07-25";
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["changeModalState"])(modalState);
  Object(_modules_images__WEBPACK_IMPORTED_MODULE_6__["images"])();
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["modals"])(modalsOff);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])(".glazing_block  ", ".glazing_content", "active");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])(".no_click", ".decoration_content >div >div", "after_click", "block", true);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])(".balcon_icons_img", ".big_img > img", "do_image_more", "inline-block");
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["form"])(modalState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["timer"])(".timer1", dataTime);
});

/***/ }),

/***/ "./src/js/modules/btnDisabledEnabled.js":
/*!**********************************************!*\
  !*** ./src/js/modules/btnDisabledEnabled.js ***!
  \**********************************************/
/*! exports provided: btnDisabled, btnEnabled */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnDisabled", function() { return btnDisabled; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnEnabled", function() { return btnEnabled; });
...
var btnCalc = Object.values(btnAll).filter(function (btn) {
  if (btn.classList.contains("popup_calc_button") || btn.classList.contains("popup_calc_profile_button")) {
    return btn;
  }
});
...
/* harmony import */ var _btnDisabledEnabled__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./btnDisabledEnabled */ "./src/js/modules/btnDisabledEnabled.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInput__WEBPACK_IMPORTED_MODULE_1__["checkNum"])("#width");
  Object(_checkNumInput__WEBPACK_IMPORTED_MODULE_1__["checkNum"])("#height");
    ...
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        if (width.value !== "" && heigth.value !== "" || checkbox !== "") {
          console.log("true");
          Object(_btnDisabledEnabled__WEBPACK_IMPORTED_MODULE_2__["btnEnabled"])();
        } else {
          Object(_btnDisabledEnabled__WEBPACK_IMPORTED_MODULE_2__["btnDisabled"])();
        }
...
var checkNum = function checkNum(selector) {
...
/* harmony import */ var _spinner__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./spinner */ "./src/js/modules/spinner.js");
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./validate */ "./src/js/modules/validate.js");
...
var form = function form(state) {
  ...
  var messages = {
    ...
    load: Object(_spinner__WEBPACK_IMPORTED_MODULE_6__["spinner"])(),
    succesfull: "отправленно",
    fail: "что-то пошло не так"
  };
  Object(_checkNumInput__WEBPACK_IMPORTED_MODULE_5__["checkNum"])('input[name="user_phone"]');
  ...
  form.forEach(function (item, i) {
    ...
    item.addEventListener("submit", function (e) {
      ...
      if (!Object(_validate__WEBPACK_IMPORTED_MODULE_7__["validString"])(i)) {
        return;
      } else {
        var statusMessages = document.createElement("div"); // создание элемента для оповещения

        statusMessages.classList.add("status");
        item.appendChild(statusMessages);
        var formData = new FormData(item); // форма для Поста клиента
...
var images = function images() {
  var imgSelector = document.querySelector(".works"),
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _btnDisabledEnabled__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./btnDisabledEnabled */ "./src/js/modules/btnDisabledEnabled.js");




var modals = function modals(modalsOff) {
  function modal(triggerModalOpen, triggerModal, triggerModalClose) {
    ...
    var input = document.querySelectorAll("input"); //   scroll = scrollHide();
    ...
    open.forEach(function (item, i) {
      ...
      item.addEventListener("click", function (e) {
        Object(_btnDisabledEnabled__WEBPACK_IMPORTED_MODULE_1__["btnDisabled"])();
  ...
  function timeModal(selector, time) {
    setTimeout(function () {
      var popupClass = document.querySelector(selector);
      var imgContent = document.querySelector(".popup-img");
...
function tabs(tabSelector, contentSelector, activeClass) {
  ...
  var contentBg = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  var nextArrow = arguments.length > 5 ? arguments[5] : undefined;
  var prewArrow = arguments.length > 6 ? arguments[6] : undefined;
  ...
  function createBg(i) {
    var path = Object.values(background);
    div.classList.add("backgroundImage");
    div.style.background = "url(".concat(path[i], ") center/cover no-repeat");
    return div;
  }
...
var inputString = sortStringInput();
var error = null;

function sortStringInput() {
  var input = document.querySelectorAll("input");
  return Object.values(input).filter(function (el, i) {
